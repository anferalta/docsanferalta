...
// Página principal
$router->get('/backups', 'BackupsAdminController@index')->name('admin.backups.index');

// Dashboard e Logs
$router->get('/backups/dashboard', 'BackupsAdminController@dashboard');
$router->get('/backups/logs', 'BackupsAdminController@logs');
...
// Página principal
$router->get('/backups', 'Admin\BackupsAdminController@index')
...
$router->get('/backups/bd/criar', 'Admin\BackupsAdminController@criarBD')
       ->name('admin.backups.bd.criar');

// 🔥 RESTAURAR + REINICIAR (tem de vir ANTES da rota restaurar normal)
$router->get('/backups/bd/restaurar-reiniciar/{ficheiro:.+}',
    'Admin\BackupsAdminController@restaurarEReiniciar')
    ->name('admin.backups.bd.restaurar.reiniciar');

// Confirmar restauro BD
$router->get('/backups/bd/restaurar/{ficheiro:.+}',
    'Admin\BackupsAdminController@restaurarConfirmar')
    ->name('admin.backups.bd.restaurar.confirmar');

// Executar restauro BD
$router->post('/backups/bd/restaurar/{ficheiro:.+}',
    'Admin\BackupsAdminController@restaurarExecutar')
    ->name('admin.backups.bd.restaurar.executar');

// Download BD
$router->get('/backups/bd/download/{ficheiro:.+}',
    'Admin\BackupsAdminController@download')
    ->name('admin.backups.bd.download');

// Apagar BD
$router->get('/backups/bd/delete/{ficheiro:.+}',
    'Admin\BackupsAdminController@delete')
    ->name('admin.backups.bd.apagar');
...
$router->get('/backups/files/criar', 'Admin\BackupsAdminController@criarFiles')
       ->name('admin.backups.files.criar');

$router->get('/backups/files/restaurar/{ficheiro:.+}',
    'Admin\BackupsAdminController@restaurarFilesConfirmar')
    ->name('admin.backups.files.restaurar.confirmar');

$router->post('/backups/files/restaurar/{ficheiro:.+}',
    'Admin\BackupsAdminController@restaurarFilesExecutar')
    ->name('admin.backups.files.restaurar.executar');

$router->get('/backups/files/download/{ficheiro:.+}',
    'Admin\BackupsAdminController@download')
    ->name('admin.backups.files.download');

$router->get('/backups/files/delete/{ficheiro:.+}',
    'Admin\BackupsAdminController@delete')
    ->name('admin.backups.files.apagar');
