...
$router->group([
    ...
    'middleware' => ['auth']
            ...
            $router->post('/agendamentos/editar/{nome}', 'Admin\\AgendamentosController@editarPost');

            $router->post('/agendamentos/ativar/{nome}', 'Admin\\AgendamentosController@ativar');
            $router->post('/agendamentos/desativar/{nome}', 'Admin\\AgendamentosController@desativar');
            $router->post('/agendamentos/eliminar/{nome}', 'Admin\\AgendamentosController@eliminar');
