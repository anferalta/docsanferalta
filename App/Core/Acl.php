...
class Acl {
    ...
    public function __construct(?int $userId = null) {
        ...
        // Sem utilizador autenticado → ACL vazia
        if (!$user) {
            $this->permissoes = [];
            $this->userId = null;
            return;
        ...
        // Carregar permissões do perfil + diretas
    ...
    public function has(string $codigo): bool {
        ...
        // 🔥 CORREÇÃO CRÍTICA:
        // Usar o sistema de permissões completo (perfil + diretas)
        return $user->hasPermissao($codigo);
    }
}
